  ...
  return (
    <>
      ...
      <div className=' my-4 py-4' id='portfolio'>
        <h2 className='my-2  text-center text-3xl uppercase font-bold text-blue-900'>PRODUCTS
        </h2>
        <div className='flex justify-center '>
          <div className='border-b-4 w-24 border-blue-900'></div>
        </div>

        <div className='px-12 mt-5' data-aos="fade-down" data-aos-delay="600">
          <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-5'>
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
              ...
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium leading-5 h-auto md:h-48"> Our Business Management System is a robust and easily scalable system that streamlines business operations, increase efficiency, and ultimately drive growth and profitability for your business.
                  ...
                  All data is stored in the cloud and as such it is easily accessible from all devices and from any location.</p>
                <div className="flex justify-center my-4">
                  <a className='text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-xl'> Schedule Demo
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
              ...
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium leading-5 h-auto md:h-48">  Our all encompassing School Management Portal is the only solution needed for any institution.
